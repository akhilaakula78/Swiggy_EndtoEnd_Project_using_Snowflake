...
--merge operation to load data into restaurant_location
...
USING (
    SELECT 
        ...
        END AS state_code,
        CASE 
            WHEN State IN ('New Delhi', 'Chandigarh', 'Puducherry', 'Jammu and Kashmir') THEN 'Y'
            ELSE 'N'
...
--creating temp table to load incorrect data;
create temp table common.location_tmp1 as select * from stage_sch.location_stm;
